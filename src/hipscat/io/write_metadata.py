...
def write_json_file(
    ...
    *,
    ...
    file_io.write_string_to_file(
        file_pointer, dumped_metadata + "\n", file_system=file_system, storage_options=storage_options
    )


def write_catalog_info(
    catalog_base_dir, dataset_info, *, file_system=None, storage_options: Union[Dict[Any, Any], None] = None
):
    ...
    write_json_file(metadata, catalog_info_pointer, file_system=file_system, storage_options=storage_options)
...
def write_provenance_info(
    ...
    *,
    ...
    write_json_file(metadata, metadata_pointer, file_system=file_system, storage_options=storage_options)
...
def write_fits_map(
    ...
    *,
    ...
    file_io.write_fits_image(
        histogram, map_file_pointer, file_system=file_system, storage_options=storage_options
    )
