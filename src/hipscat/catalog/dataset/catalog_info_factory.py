...
def from_catalog_dir(
    catalog_base_dir: FilePointer, *, file_system=None, storage_options: Union[Dict[Any, Any], None] = None
):
    ...
    Returns:
        populated BaseCatalogInfo of appropriate type.
    """
    if file_io.is_regular_file(catalog_base_dir, file_system=file_system, storage_options=storage_options):
