...
def filter_pixels_by_polygon(pixel_tree: PixelTree, vertices) -> List[HealpixPixel]:
    ...
    return pixel_list, polygon_pixels, max_order

def _generate_polygon_pixel_tree(vertices, order: int):
    ...
    return polygon_tree, polygon_pixels
