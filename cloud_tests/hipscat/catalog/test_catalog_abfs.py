...
def test_cone_filter(small_sky_order1_catalog_abfs):
    filtered_catalog = small_sky_order1_catalog_abfs.filter_by_cone(315, -66.443, 0.1)
...
def test_cone_filter_big(small_sky_order1_catalog_abfs):
    filtered_catalog = small_sky_order1_catalog_abfs.filter_by_cone(315, -66.443, 30)
...
def test_cone_filter_empty(small_sky_order1_catalog_abfs):
    filtered_catalog = small_sky_order1_catalog_abfs.filter_by_cone(0, 0, 0.1)
...
def test_empty_directory(tmp_dir_abfs, example_abfs_storage_options):
    ...
    with pytest.raises(FileNotFoundError):
        Catalog.read_from_hipscat(catalog_path, storage_options=example_abfs_storage_options)
    ...
    catalog = Catalog.read_from_hipscat(catalog_path, storage_options=example_abfs_storage_options)
    ...
    file_io.delete_file(os.path.join(catalog_path, "partition_info.csv"), storage_options=example_abfs_storage_options)
