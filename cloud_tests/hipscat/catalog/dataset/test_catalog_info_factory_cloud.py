...
def test_from_catalog_dir_object(small_sky_dir_cloud, example_cloud_storage_options):
    catalog_info = from_catalog_dir(small_sky_dir_cloud, example_cloud_storage_options)
