...
def test_read_from_file(base_catalog_info_file_cloud, example_cloud_storage_options, assert_catalog_info_matches_dict):
    base_cat_info_fp = file_io.get_file_pointer_from_path(base_catalog_info_file_cloud)
    catalog_info = BaseCatalogInfo.read_from_metadata_file(base_cat_info_fp, storage_options=example_cloud_storage_options)
