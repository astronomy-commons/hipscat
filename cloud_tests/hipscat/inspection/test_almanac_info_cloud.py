...
def test_from_catalog_dir(small_sky_dir_cloud, example_cloud_storage_options):
    ...
    almanac_info = AlmanacInfo.from_catalog_dir(small_sky_dir_cloud, storage_options=example_cloud_storage_options)
...
def test_from_bad_file(association_catalog_partition_join_file_cloud, example_cloud_storage_options):
    ...
    with pytest.raises(ValueError, match="csv"):
        AlmanacInfo.from_file(association_catalog_partition_join_file_cloud, storage_options=example_cloud_storage_options)
...
def test_write_to_file(tmp_dir_cloud, association_catalog_path_cloud, example_cloud_storage_options):
    ...
    almanac_info = AlmanacInfo.from_catalog_dir(association_catalog_path_cloud, storage_options=example_cloud_storage_options)
    ...
    almanac_info.write_to_file(tmp_dir_cloud, default_dir=False, storage_options=example_cloud_storage_options)

    new_info = AlmanacInfo.from_file(os.path.join(tmp_dir_cloud, "small_sky_to_small_sky_order1.yml"), storage_options=example_cloud_storage_options)
    ...
    file_io.delete_file(os.path.join(tmp_dir_cloud, "small_sky_to_small_sky_order1.yml"), storage_options=example_cloud_storage_options)
...
def test_write_to_file_load_almanac(tmp_dir_cloud, small_sky_dir_cloud, example_cloud_storage_options):
    ...
    alms = Almanac(include_default_dir=False, dirs=tmp_dir_cloud, storage_options=example_cloud_storage_options)
    assert len(alms.catalogs()) == 1

    file_io.delete_file(os.path.join(tmp_dir_cloud, "small_sky.yml"), storage_options=example_cloud_storage_options)
...
def test_write_to_bad_file(tmp_dir_cloud, small_sky_dir_cloud, example_cloud_storage_options):
    ...
    with pytest.raises(ValueError, match="only one"):
        almanac_info.write_to_file(tmp_dir_cloud, default_dir=True, storage_options=example_cloud_storage_options)
...
def test_association_fields(association_catalog_path_cloud, index_catalog_info_file_cloud, small_sky_dir_cloud, example_cloud_storage_options):
    ...
    almanac_info = AlmanacInfo.from_catalog_dir(index_catalog_info_file_cloud, storage_options=example_cloud_storage_options)
