...
def test_generate_map(small_sky_dir_abfs, example_abfs_storage_options, projection):
...
def test_generate_map_unknown_projection(small_sky_dir_abfs, example_abfs_storage_options):
...
def test_generate_map_order1(small_sky_order1_dir_abfs, example_abfs_storage_options):
    """Basic test that map data can be generated (does not test that a plot is rendered)"""
